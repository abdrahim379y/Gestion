...
const onLogout = (ev) => {
  ...
  return (
    ...
    <div class="font-bold flex items-end gap-1">
      <span class="text-6xl font-bold text-purple-600 ">Gesti</span>
      <svg
      ...
      <span class="text-6xl text-purple-600 font-bold">n</span>
    </div>
           <nav className="py-3 px-4 flex items-center justify-between ms-auto text-purple-600">
              <Link className="text-sm px-4 py-2 leading-none rounded-full  font-bold  text-gray-900 hover:text-purple-600" to="/" >Home</Link>
              <Link className="text-sm px-4 py-2 leading-none rounded-full  font-bold  text-gray-900 hover:text-purple-600" to="/admin/about" >About</Link>
              <Link className="text-sm px-4 py-2 font-bold  text-gray-900 leading-none rounded-full  hover:text-purple-600" to="/admin/dashboard" >Dashboard</Link>
              <Link className="text-sm px-4 py-2 leading-none rounded-full font-bold  text-gray-900 hover:text-purple-600" to="/admin/contact" >Contact</Link>
            <input className="text-sm px-4 py-2 leading-none w-auto rounded-full border-2 border-purple-500 text-purple-600 hover:text-white hover:bg-purple-600 m-0" type="submit" onClick={onLogout} value="Log out" />
          </nav>
          </header>
        <main>
          <Outlet/>
