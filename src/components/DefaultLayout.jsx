    ...
    <div class="font-bold flex items-end gap-1">
      ...
      <span class="text-6xl text-purple-600 font-bold">n</span>
            ...
            <nav className="py-3 px-4 flex items-center justify-between ms-auto text-purple-600">
              ...
              <Link className="text-sm px-4 py-2 leading-none rounded-full  font-bold  text-gray-900 hover:text-purple-600" to="/about" >About</Link>
              <Link className="text-sm px-4 py-2 leading-none rounded-full font-bold  text-gray-900 hover:text-purple-600" to="/users" >Users</Link> 
              <Link className="text-sm px-4 py-2 leading-none rounded-full font-bold  text-gray-900 hover:text-purple-600" to="/contact" >Contact</Link>
