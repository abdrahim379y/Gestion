  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: "space-between", alignItems: "center" }}>
        <h1 className="text-4xl font-bold m-5">Stagaires</h1>
        <Link className=" bg-purple-500 hover:bg-purple-600 text-white border py-2 px-8 text-center text-xs leading-tight  rounded-lg " to="/admin/users/new">Add new</Link>
      </div>
      {Hide ? <>
      ...
      <section className=" mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-10 gap-x-14 mt-10 mb-5">
            ...
            <div
              ...
              <div class="w-full sm:w-auto flex flex-col items-center sm:items-start">
                ...
                <div class="mb-2 flex flex-col justify-between text-gray-600 sm:flex-row">
                  <h3 class="font-bold text-2xl">{u.name}</h3>
                </div>
                ...
                <div class="mt-5 flex items-center justify-between text-white">
                  ...
                  <div className="">
                    <Link to={'/admin/users/' + u.id} class="  text-white cursor-pointer border py-2 px-8 text-center text-xs leading-tight  rounded-lg bg-purple-500  hover:bg-purple-600">Edit</Link>
                    <Link to={'/admin/usersDetails/' + u.id} class="  text-white cursor-pointer border py-2 px-8 text-center text-xs leading-tight  rounded-lg bg-purple-500  hover:bg-purple-600">showDetails</Link>
                    <button onClick={ev => onDeleteClick(u)} class=" text-white cursor-pointer border py-2 px-8 text-center text-xs leading-tight  rounded-lg bg-red-500 hover:bg-red-600 m-3" to={'admin/dashboard/' + u.id}>Delete</button>
